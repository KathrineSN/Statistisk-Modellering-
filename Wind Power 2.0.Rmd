...
```{r, warning=FALSE}
par(mfrow=c(1,2))
qqnorm(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)),main="Distribution after transformation 1")
qqline(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))
qqnorm(data$pow.obs.norm, pch = 1, frame = TRUE, main="Distribution before transformation")
qqline(data$pow.obs.norm, col = "steelblue")
```
...
```{r}
par(mfrow=c(1,2))
qqnorm(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)),main="Distribution after transformation 2")
qqline(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))
qqnorm(data$pow.obs.norm, pch = 1, frame = TRUE, main="Distribution before transformation")
qqline(data$pow.obs.norm, col = "steelblue")
```
...
results[3,2] =round(AIC(2,-beta.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$objective))
results[4,2] =round(AIC(2,-beta.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$objective))
...
results[3,3] =round(AIC(2,-gamma.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$objective))
results[4,3] =round(AIC(2,-gamma.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$objective))
...
results[3,4] =round(AIC(2,-log.normal.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$objective))
results[4,4] =round(AIC(2,-log.normal.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$objective))
...
```
The best model fitting the power observation is to use transformation 1 and then the Gamma Distribution. If no transformation is made to data the beta model is best. The best model for wind speed is the gamma model, and the best model for wind direction is the beta model.
...
results2[3,2] =round(beta.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$par[1],2)
results2[3,3] =round(beta.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$par[2],2)
results2[3,4] =round(beta.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI1[1],2)
results2[3,5] =round(beta.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI1[2],2)
results2[3,6] =round(beta.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI2[1],2)
results2[3,7] =round(beta.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI2[2],2)

results2[4,2] =round(beta.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$par[1],2)
results2[4,3] =round(beta.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$par[2],2)
results2[4,4] =round(beta.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI1[1],2)
results2[4,5] =round(beta.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI1[2],2)
results2[4,6] =round(beta.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI2[1],2)
results2[4,7] =round(beta.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI2[2],2)
...
results3[3,2] =round(gamma.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$par[1],2)
results3[3,3] =round(gamma.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$par[2],2)
results3[3,4] =round(gamma.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI1[1],2)
results3[3,5] =round(gamma.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI1[2],2)
results3[3,6] =round(gamma.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI2[1],2)
results3[3,7] =round(gamma.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI2[2],2)

results3[4,2] =round(gamma.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$par[1],2)
results3[4,3] =round(gamma.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$par[2],2)
results3[4,4] =round(gamma.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI1[1],2)
results3[4,5] =round(gamma.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI1[2],2)
results3[4,6] =round(gamma.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI2[1],2)
results3[4,7] =round(gamma.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI2[2],2)
...
results4[3,2] =round(log.normal.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$par[1],2)
results4[3,3] =round(log.normal.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$par[2],2)
results4[3,4] =round(log.normal.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI1[1],2)
results4[3,5] =round(log.normal.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI1[2],2)
results4[3,6] =round(log.normal.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI2[1],2)
results4[3,7] =round(log.normal.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$CI2[2],2)

results4[4,2] =round(log.normal.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$par[1],2)
results4[4,3] =round(log.normal.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$par[2],2)
results4[4,4] =round(log.normal.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI1[1],2)
results4[4,5] =round(log.normal.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI1[2],2)
results4[4,6] =round(log.normal.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI2[1],2)
results4[4,7] =round(log.normal.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$CI2[2],2)
...
```{r}
x <- normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm))
h<-hist(x, xlab="Power Obs Transformation 1",
   main="Histogram Gamma Power Obs Transformation 1")
xfit<-seq(min(x),max(x),length=40)
yfit<-dgamma(xfit,gamma.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$par[1],gamma.function(normalize(trans1(opt.lambda.trans1$maximum,data$pow.obs.norm)))$opt$par[2])
yfit <- yfit*diff(h$mids[1:2])*length(x)
lines(xfit, yfit, col="blue", lwd=2)
```

```{r}
x <- normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm))
h<-hist(x, xlab="Power Obs Transformation 2",
   main="Histogram Gamma Power Obs Transformation 2")
xfit<-seq(min(x),max(x),length=40)
yfit<-dgamma(xfit,gamma.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$par[1],gamma.function(normalize(trans2(opt.lambda.trans2$maximum,data$pow.obs.norm)))$opt$par[2])
yfit <- yfit*diff(h$mids[1:2])*length(x)
lines(xfit, yfit, col="blue", lwd=2)
```
